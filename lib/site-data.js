...
/**
 * Sayfa başlığını marka son ekiyle birlikte 60 karaktere sığdırır.
 * Marka yalnızca yer kalıyorsa eklenir; asla iki kez eklenmez.
 */
export function pageTitle(base, { marka = firma.kisaAd } = {}) {
